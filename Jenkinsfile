pipeline {
    ...
    parameters {
		 ...
		 string(name: 'tomcat_prod_hostkey', defaultValue: 'ssh-ed25519 256 uTXzb3wdfK2qMEL2uvyENbnV+KgErSIuJhYQ5EgRmeU=.', description: 'AWS EC2 host key fingerprint for Staging')
    }
